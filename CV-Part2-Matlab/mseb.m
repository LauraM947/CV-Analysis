...
%
% 2021-09-20 Laura Martin polished the comments on the script
%
%
% Inputs
...
for c = 1:C
    ...
    %extract the RGB value of the main plot line. So we remove the main line
    %and put it back to make it appear again
    delete(H(c).mainLine)
